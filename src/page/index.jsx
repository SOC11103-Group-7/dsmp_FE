  ...
  return (
    <div className='flex bg-yellow-50'>
      ...
      <div className='flex flex-col w-full md:w-1/2 px-10'>
        <div className='w-full h-40 bg-gray-300 border border-black rounded-lg overflow-hidden mt-6'>
        ...
        <div className='w-full bg-gray-300 border border-black rounded-lg overflow-hidden mt-4'>
          <div className='flex items-center p-2'>
            ...
            <div className='ml-2'>
              ...
              <span className='text-xs text-red-600 ml-2'>25mins ago</span>
            </div>
          </div>
          ...
          <button className='w-16 h-6 m-2 bg-gray-300 text-gray-900 font-bold text-xs rounded-md border border-black'>Tip 0.1ETH</button>
          </span>
